                ...
                <div class="am-fr tpl-header-navbar">
                    <ul>
                        ...
                        <li class="am-text-sm tpl-header-navbar-welcome">
                            <a href="javascript:;">欢迎你：<?php if($_SESSION['admin']['user_name']== 'admin'): ?>超级管理员<?php else: echo ($_SESSION['admin']['user_name']); endif; ?><span></span> </a>
                        </li>
 ...
 -->
        ...
        <div class="left-sidebar">
            ...
            <div class="tpl-sidebar-user-panel">
              ...
              <?php if($_SESSION['admin']['user_name']== 'admin'): ?>超级管理员<?php else: echo ($_SESSION['admin']['user_name']); endif; ?>
          </span>
            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 德沃 </div>
                        <p class="page-header-description">悦美快线APP后台管理系统</p>
                    </div>
